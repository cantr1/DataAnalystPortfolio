...
def repair_assistant():
    """
    1. Takes a username and password before accessing program
    2. Takes input of copied failure code
    3. Searches failure code in dictionary keys
    4. Returns value from dictionary - 'repair_info'
    5. Logs the repair
    6. Added function of printing repair logs if needed
    """
